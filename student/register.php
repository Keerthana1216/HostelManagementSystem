...
if(isset($_POST['register'])){
    ...
    $query = "update students set password = '$_POST[password]' where email = '$_POST[email]'";
        ...
        <div class="col-md-6">
            ...
            <div class="card login-container">
                <div class="card-header">
                    <center><b>Student Registration</b></center>
                </div>
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <br>
                        <center><span>Already registered? <a href="index2.php">Login here</a></span></center>
                    </form>
                </div>
            </div><br>
